...
@if $enable-dark-mode {
	...
	$theme-colors-text-dark: ("primary": $primary-text-emphasis-dark,
	...
	$theme-colors-bg-subtle-dark: ("primary": $primary-bg-subtle-dark,
	...
	$theme-colors-border-subtle-dark: ("primary": $primary-border-subtle-dark,
